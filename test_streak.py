import unittest
import datetime
from streak import streak_reset, yesterday_check, daily_reward, add_streak_freeze
...
class TestStreak(unittest.TestCase):
    ...
    def test_add_streak_free_success(self):
        testcredits = 30
        expected_result = {"credits_to_add": -30,
                           "freeze_to_add": 1}
        self.assertEqual(add_streak_freeze(testcredits), expected_result)

    def test_add_streak_free_unsuccessful(self):
        testcredits = 29
