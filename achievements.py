...
def check_achievement(required_stat: str, required_value: int, tasks_completed: int, high_priority_tasks_completed: int, medium_priority_tasks_completed: int, low_priority_tasks_completed: int, rewards_claimed: int):
...
def check_achievements(save_file_path: str, tasks_completed: int, high_priority_tasks_completed: int, medium_priority_tasks_completed: int, low_priority_tasks_completed: int, rewards_claimed: int)->int:
    credits_to_add = 0
    if achievementlist == []:
